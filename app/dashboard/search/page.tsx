    ...
    return (
        <div className="p-6 max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-foreground">AI Network Search</h1>
                    <p className="text-muted-foreground">Ask questions about your network in plain English.</p>
                </div>
            </div>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-2">
                                                    ...
                                                    {contact.source === 'shared' && contact.owner_name && (
